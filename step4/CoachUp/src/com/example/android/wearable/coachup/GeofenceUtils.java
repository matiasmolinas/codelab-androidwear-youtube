...
public final class GeofenceUtils {
    ...
    public static final String ACTION_CONNECTION_ERROR =
            "com.example.android.wearable.coachup.ACTION_CONNECTION_ERROR";

    public static final String ACTION_CONNECTION_SUCCESS =
            "com.example.android.wearable.coachup.ACTION_CONNECTION_SUCCESS";

    public static final String ACTION_GEOFENCES_ADDED =
            "com.example.android.wearable.coachup.ACTION_GEOFENCES_ADDED";

    public static final String ACTION_GEOFENCES_REMOVED =
            "com.example.android.wearable.coachup.ACTION_GEOFENCES_DELETED";

    public static final String ACTION_GEOFENCE_ERROR =
            "com.example.android.wearable.coachup.ACTION_GEOFENCES_ERROR";

    public static final String ACTION_GEOFENCE_TRANSITION =
            "com.example.android.wearable.coachup.ACTION_GEOFENCE_TRANSITION";

    public static final String ACTION_GEOFENCE_TRANSITION_ERROR =
                    "com.example.android.wearable.coachup.ACTION_GEOFENCE_TRANSITION_ERROR";

    // The Intent category used by all Location Services sample apps
    public static final String CATEGORY_LOCATION_SERVICES =
                    "com.example.android.wearable.coachup.CATEGORY_LOCATION_SERVICES";
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "com.example.android.wearable.coachup.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "com.example.android.wearable.coachup.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "com.example.android.wearable.coachup.EXTRA_GEOFENCE_STATUS";

    // The prefix for flattened geofence keys
    public static final String KEY_PREFIX =
            "com.example.android.wearable.coachup.KEY";
